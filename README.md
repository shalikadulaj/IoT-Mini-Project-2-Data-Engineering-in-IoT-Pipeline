...
3. The script processes incoming data, detecting outliers and predicting future values using [linear regression](https://www.mathworks.com/help/stats/what-is-linear-regression.html).
